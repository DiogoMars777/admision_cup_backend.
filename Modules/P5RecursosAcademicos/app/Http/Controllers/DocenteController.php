...
class DocenteController extends Controller
{
    ...
    {
        $query = \Modules\P5RecursosAcademicos\Models\Docente::query()
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $rolDocente = \Modules\P1SeguridadYAuditoria\Models\Rol::where('nombre', 'Docente')->first();
            if ($rolDocente) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            \Modules\P5RecursosAcademicos\Models\Docente::where('id_persona', $id)->update([
                'grado_academico' => $request->grado_academico,
                'experiencia_docente' => $request->experiencia_docente,
                'updated_at' => now(),
            ]);
    ...
    {
        \Modules\P5RecursosAcademicos\Models\Docente::where('id_persona', $id)->delete();
