...
class UsuarioController extends Controller
{
    ...
    {
        $query = \Modules\P1SeguridadYAuditoria\Models\Usuario::query()
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $userId = \Modules\P1SeguridadYAuditoria\Models\Usuario::insertGetId([
    ...
    {
        $usuario = \Modules\P1SeguridadYAuditoria\Models\Usuario::where('id', $id)->first();
        ...
        DB::beginTransaction();
        try {
            \Modules\P1SeguridadYAuditoria\Models\Persona::where('id', $usuario->id_persona)->update([
                'nombre' => $request->nombre,
                'updated_at' => now(),
            ]);
            ...
            \Modules\P1SeguridadYAuditoria\Models\Usuario::where('id', $id)->update($updateData);
    ...
    public function toggleStatus(Request $request, $id)
    {
        ...
        \Modules\P1SeguridadYAuditoria\Models\Usuario::where('id', $id)->update(['estado' => $nuevoEstado]);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        \Modules\P1SeguridadYAuditoria\Models\Usuario::where('id', $id)->delete();
    ...
    {
        return response()->json(\Modules\P1SeguridadYAuditoria\Models\Rol::select('id', 'nombre')->get());
    }

    private function logBitacora($idUsuario, $accion, $modulo, $descripcion, $ip)
    {
        \Modules\P1SeguridadYAuditoria\Models\Bitacora::insert([
