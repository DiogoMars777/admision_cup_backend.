...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $persona = \Modules\P1SeguridadYAuditoria\Models\Persona::where('id', $user->id_persona)->first();
        $rol = \Modules\P1SeguridadYAuditoria\Models\Rol::where('id', $user->id_rol)->value('nombre') ?? 'Desconocido';
